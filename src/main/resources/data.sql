...
CREATE CONSTANT BOOKING_TIME_2026_03_01_21_00_00 VALUE TIMESTAMP '2026-03-01 21:00:00';
...
INSERT INTO bookings (id, pitch_id, player_id, start_at, end_at, status, lock_expires_at, recurring, recurrence_group_id) VALUES
    ...
    (3, 3, 3, BOOKING_TIME_2026_03_01_21_00_00, TIMESTAMP '2026-03-01 22:00:00', BOOKING_STATUS_CONFIRMED, BOOKING_NO_LOCK_EXPIRES_AT, BOOKING_NOT_RECURRING, BOOKING_NO_RECURRENCE_GROUP),
    (4, 4, 4, TIMESTAMP '2026-03-01 19:00:00', BOOKING_TIME_2026_03_01_21_00_00, 'CANCELLED', BOOKING_NO_LOCK_EXPIRES_AT, BOOKING_NOT_RECURRING, BOOKING_NO_RECURRENCE_GROUP),
    (5, 5, 2, TIMESTAMP '2026-03-01 19:30:00', BOOKING_TIME_2026_03_01_21_00_00, 'LOCKED', TIMESTAMP '2026-03-01 19:35:00', BOOKING_NOT_RECURRING, BOOKING_NO_RECURRENCE_GROUP);
